...
import { SLATE_900, WHITE, SLATE_500, RED_50, RED_200, RED_DARK, SLATE_400, SLATE_200, BLUE, BLUE_SOFT } from '@/theme';
            ...
            <div style={{
                ...
                >
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                        <label style={{ fontSize: 13, fontWeight: 500, color: SLATE_900 }}>Email</label>
                        <div style={{ position: 'relative' }}>
                            ...
                            <input
                                ...
                                onBlur={e => e.target.style.borderColor = SLATE_200}
                            />
                        </div>
                    </div>
                    ...
                    {/* Password */}
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                        <label style={{ fontSize: 13, fontWeight: 500, color: SLATE_900 }}>Kata Sandi</label>
                        <div style={{ position: 'relative' }}>
                            <Lock size={18} style={{
                                position: 'absolute',
                                left: 14,
                    ...
                    <button
                        ...
                        style={{
                            width: '100%',
                            height: 44,
                            background: processing ? BLUE_SOFT : BLUE,
                            color: WHITE,
                            border: 'none',
                            borderRadius: 8,
                            fontSize: 14,
