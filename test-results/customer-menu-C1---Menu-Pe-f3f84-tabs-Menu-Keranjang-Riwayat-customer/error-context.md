...
- Name: customer/menu.spec.ts >> C1 - Menu Pelanggan >> displays bottom navigation with 3 tabs: Menu, Keranjang, Riwayat
- Location: tests/playwright/customer/menu.spec.ts:44:3
...
Call log:
  ...
  - waiting for getByText('Menu').first()
