...
// Kasir pages
Route::prefix('kasir')->middleware(['auth', 'role:cashier,admin'])->group(function () {
    ...
    Route::get('/riwayat',       [CashierRiwayatController::class, 'index'])->name('kasir.riwayat');
    ...
    Route::get('/pesanan-menunggu', \App\Http\Controllers\Cashier\CashierPendingCountController::class)->name('kasir.pesanan-menunggu');
});
...
Route::middleware(['auth', 'role:kitchen,admin'])->group(function () {
    ...
    Route::get('/dapur/riwayat', [KitchenController::class, 'riwayat'])->name('dapur.riwayat');
