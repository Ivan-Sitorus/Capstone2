...
class ClusteringBahanBakuHistoryWidget extends TableWidget
{
    ...
    {
        return $table
            ->heading('Riwayat Klasterisasi Bahan Baku')
            ->records(function () {
                return DataminingRun::completedHistory('clustering-bahan-baku', 10)
