...
class ViewPiutang extends ViewRecord
{
    ...
    protected function getHeaderActions(): array
    {
        return [
            Actions\Action::make('recordPayment')
                ...
                ->color('success')
                ->visible(fn (Order $record): bool => $this->isPiutang($record) && $this->isBelumLunas($record))
                ->form([
    ...
    public function infolist(Schema $schema): Schema
    {
        return parent::infolist($schema)->components([
            ...
            Section::make('Riwayat Pembayaran')
                ->visible(fn (Order $record): bool => $this->isPiutang($record))
                ->schema([
    ...
    private function isPiutang(Order $record): bool
    {
        return in_array($record->payment_method, ['bayar_nanti', 'piutang'], true);
    }

    private function isBelumLunas(Order $record): bool
    {
        return $record->status === 'belum_lunas';
    }
}
