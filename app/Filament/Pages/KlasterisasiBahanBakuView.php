...
use App\Filament\Widgets\IngredientBarChart;
...
class KlasterisasiBahanBakuView extends Page
{
    ...
    protected static ?string $slug = 'ingredient-clustering/{id}';
    ...
    {
        return [
            IngredientBarChart::make(['recordId' => $this->record->id]),
                    ...
                    Tab::make('Hasil Klaster')
                        ...
                        ->schema([
                            ...
                            Section::make('Tabel Hasil')
                                ->description('Detail bahan baku per klaster')
                                ->collapsible()
