...
*Testing was conducted using black box, white box, and gray box testing methods. Black box testing across all modules showed scenarios passed. White box testing validated FIFO and FEFO algorithms. Gray box testing validated data consistency across modules. All stock deduction mechanisms and movement recording functioned as designed.*
